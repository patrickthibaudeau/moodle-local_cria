...
function process_notes() {
    ...
    $("#process-notes").on('click', function () {
        ...
        prompt += 'Evaluate the following student assessment based on the provided rubric. Separate each skills into a list and always provide a sentence ' +
            ...
            'points that can be obtained in each criteria. Do the proper math based on the following formuala ((total score obtained on the assignment / total possible score)*100)\n' +
            'Only print the Final score result based on the previous formula. At the bottom, provide 3-5 answers to the student on improving their writing moving forward.'
        prompt += '[/INSTRUCTIONS]';
