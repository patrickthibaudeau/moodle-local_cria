...
datatables::set_table('local_cria_question');
...
datatables::set_select_option_class_name('cria-question-');
datatables::set_action_item_buttons(
    [
        [
            'href' => '/local/cria/edit_question.php',
        ...
        [
            ...
            'class' => 'btn btn-link btn-lg text-danger delete-question',
            'query_strings' => ['id']
        ]
    ]
);
