...
class intent extends crud
{
    ...
    {
        $new_intents_id  = parent::insert_record($data); // TODO: Change the autogenerated stub
        if ($data->published) {
            $NEW_INTENT = new intent($new_intents_id);
            $NEW_INTENT->create_intent_on_bot_server();
        }

        return $new_intents_id;
    }
    ...
    public function create_intent_on_bot_server()
    {
        ...
        criabot::bot_create((string)$bot_name, $this->get_bot_parameters_json());
    }
